...
import {
  doSignInWithGoogle,
  doSignInWithGithub,
} from "../firesbase-authentication/auth";
        ...
        <Form onSubmit={handleSubmit}>
          <div className="">
            <button
              ...
              className="w-full max-w-xs font-bold shadow-sm py-3 px-3 bg-thirdColor text-white flex items-center justify-center duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
            >
